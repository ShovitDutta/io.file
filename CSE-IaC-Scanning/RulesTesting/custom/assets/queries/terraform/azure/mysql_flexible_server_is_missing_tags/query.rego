...
CxPolicy[result] {
	...
	not azuremysqlflexibleserver.tags.itpmid
...
CxPolicy[result] {
	azuremysqlflexibleserver := input.document[i].resource.azurerm_mysql_flexible_server[name]
	not azuremysqlflexibleserver.tags.costcenter
...
CxPolicy[result] {
	azuremysqlflexibleserver := input.document[i].resource.azurerm_mysql_flexible_server[name]
	not azuremysqlflexibleserver.tags.dataclassification
...
CxPolicy[result] {
	azuremysqlflexibleserver := input.document[i].resource.azurerm_mysql_flexible_server[name]
	not azuremysqlflexibleserver.tags.environmenttype
...
CxPolicy[result] {
	azuremysqlflexibleserver := input.document[i].resource.azurerm_mysql_flexible_server[name]
	not azuremysqlflexibleserver.tags.sharedemailaddress
