...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": sprintf("'azurerm_network_security_rule[%s].destination_port_range' cannot be 3389", [name]),
		"keyActualValue": sprintf("'azurerm_network_security_rule[%s].destination_port_range' might be 3389", [name]),
	}
}
