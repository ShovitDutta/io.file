...
isSmallPublicNetwork(ingress) {
	endswith(ingress.cidr_blocks[_], "/25")
} else {
	endswith(ingress.cidr_blocks[_], "/26")
} else {
	endswith(ingress.cidr_blocks[_], "/27")
} else {
	endswith(ingress.cidr_blocks[_], "/28")
} else {
	endswith(ingress.cidr_blocks[_], "/29")
}
