...
CxPolicy[result] {
    ...
    result := {
    		...
    		"keyExpectedValue": "'backup_retention_period' should be defined, and should be minimum of 7 days",
...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": "'backup_retention_period' should minimum of 7 days",
