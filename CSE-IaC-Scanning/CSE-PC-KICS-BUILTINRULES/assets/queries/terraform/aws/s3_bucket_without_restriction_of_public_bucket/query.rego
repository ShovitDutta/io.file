...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": sprintf("aws_s3_bucket_public_access_block[%s].restrict_public_buckets should equal 'true'", [bucket_name]),
		"keyActualValue": sprintf("aws_s3_bucket_public_access_block[%s].restrict_public_buckets is equal to 'false'", [bucket_name]),
