...
CxPolicy[result] {
	...
	result := {
		...
		"keyExpectedValue": sprintf("aws_s3_bucket_public_access_block[%s].block_public_acls should equal 'true'", [name]),
		"keyActualValue": sprintf("aws_s3_bucket_public_access_block[%s].block_public_acls is equal 'false'", [name]),
