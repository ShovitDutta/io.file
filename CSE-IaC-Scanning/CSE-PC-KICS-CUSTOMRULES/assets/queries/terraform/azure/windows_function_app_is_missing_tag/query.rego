...
CxPolicy[result] {
	...
	not common_lib.valid_key(azureFunction.tags,"itpmid")
...
CxPolicy[result] {
	azureFunction := input.document[i].resource.azurerm_windows_function_app[name]
	not common_lib.valid_key(azureFunction.tags,"costcenter")
...
CxPolicy[result] {
	azureFunction := input.document[i].resource.azurerm_windows_function_app[name]
	not common_lib.valid_key(azureFunction.tags,"dataclassification")
...
CxPolicy[result] {
	azureFunction := input.document[i].resource.azurerm_windows_function_app[name]
	not common_lib.valid_key(azureFunction.tags,"environmenttype")
...
CxPolicy[result] {
	azureFunction := input.document[i].resource.azurerm_windows_function_app[name]
	not common_lib.valid_key(azureFunction.tags,"sharedemailaddress")
