...
# This policy checks if the azurerm_cognitive_account (Computer Vision Services) resource has local_auth_enabled set to false.
...
CxPolicy[result] {
	...
	az_computervision_service.local_auth_enabled == true
