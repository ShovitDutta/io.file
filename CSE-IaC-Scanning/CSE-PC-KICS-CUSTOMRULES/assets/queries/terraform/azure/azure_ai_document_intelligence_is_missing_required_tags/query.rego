...
CxPolicy[result] {
	...
	not common_lib.valid_key(az_documentintelligence_service.tags,"itpmid")
...
CxPolicy[result] {
	az_documentintelligence_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_documentintelligence_service.kind == "FormRecognizer"	
	not common_lib.valid_key(az_documentintelligence_service.tags,"costcenter")
...
CxPolicy[result] {
	az_documentintelligence_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_documentintelligence_service.kind == "FormRecognizer"	
	not common_lib.valid_key(az_documentintelligence_service.tags,"dataclassification")
...
CxPolicy[result] {
	az_documentintelligence_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_documentintelligence_service.kind == "FormRecognizer"	
	not common_lib.valid_key(az_documentintelligence_service.tags,"environmenttype")
...
CxPolicy[result] {
	az_documentintelligence_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_documentintelligence_service.kind == "FormRecognizer"
	not common_lib.valid_key(az_documentintelligence_service.tags,"sharedemailaddress")
