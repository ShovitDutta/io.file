...
# This policy checks if the azurerm_cognitive_account (ContentSafety Servcices) resource has public_network_access_enabled set to false.
...
CxPolicy[result] {
	...
	az_contentsafety_service.public_network_access_enabled == true
