...
CxPolicy[result] {
	az_speech_service_tags := input.document[i].resource.azurerm_cognitive_account[name].tags
	not common_lib.valid_key(az_speech_service_tags,"itpmid")
	
	result := {
		"documentId": input.document[i].id,
		"resourceType": "azurerm_cognitive_account",
		"resourceName": tf_lib.get_resource_name(az_speech_service_tags, name),
...
CxPolicy[result] {
	az_speech_service_tags := input.document[i].resource.azurerm_cognitive_account[name].tags
	not common_lib.valid_key(az_speech_service_tags,"costcenter")
...
CxPolicy[result] {
	az_speech_service_tags := input.document[i].resource.azurerm_cognitive_account[name].tags
	not common_lib.valid_key(az_speech_service_tags,"dataclassification")
...
CxPolicy[result] {
	az_speech_service_tags := input.document[i].resource.azurerm_cognitive_account[name].tags
	not common_lib.valid_key(az_speech_service_tags,"environmenttype")
...
CxPolicy[result] {
	az_speech_service_tags := input.document[i].resource.azurerm_cognitive_account[name].tags
	not common_lib.valid_key(az_speech_service_tags,"sharedemailaddress")
