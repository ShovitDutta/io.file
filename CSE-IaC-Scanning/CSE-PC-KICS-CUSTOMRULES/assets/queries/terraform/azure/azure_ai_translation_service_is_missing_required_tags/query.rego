...
CxPolicy[result] {
	...
	not common_lib.valid_key(az_translation_service.tags,"itpmid")
...
CxPolicy[result] {
	az_translation_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_translation_service.kind == "TextTranslation"	
	not common_lib.valid_key(az_translation_service.tags,"costcenter")
...
CxPolicy[result] {
	az_translation_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_translation_service.kind == "TextTranslation"	
	not common_lib.valid_key(az_translation_service.tags,"dataclassification")
...
CxPolicy[result] {
	az_translation_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_translation_service.kind == "TextTranslation"	
	not common_lib.valid_key(az_translation_service.tags,"environmenttype")
...
CxPolicy[result] {
	az_translation_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_translation_service.kind == "TextTranslation"
	not common_lib.valid_key(az_translation_service.tags,"sharedemailaddress")
