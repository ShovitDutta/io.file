...
# This policy checks if the azurerm_cognitive_account (Speech Servcices) resource has public_network_access_enabled set to false.
...
CxPolicy[result] {
	...
	az_translation_service.public_network_access_enabled == true
