...
CxPolicy[result] {
	...
	not common_lib.valid_key(az_contentsafety_service.tags,"itpmid")
...
CxPolicy[result] {
	az_contentsafety_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_contentsafety_service.kind == "ContentSafety"	
	not common_lib.valid_key(az_contentsafety_service.tags,"costcenter")
...
CxPolicy[result] {
	az_contentsafety_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_contentsafety_service.kind == "ContentSafety"	
	not common_lib.valid_key(az_contentsafety_service.tags,"dataclassification")
...
CxPolicy[result] {
	az_contentsafety_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_contentsafety_service.kind == "ContentSafety"	
	not common_lib.valid_key(az_contentsafety_service.tags,"environmenttype")
...
CxPolicy[result] {
	az_contentsafety_service := input.document[i].resource.azurerm_cognitive_account[name]
	az_contentsafety_service.kind == "ContentSafety"
	not common_lib.valid_key(az_contentsafety_service.tags,"sharedemailaddress")
