...
# This policy checks if the azurerm_cognitive_account (TextAnalytics) resource has local_auth_enabled set to false.
...
CxPolicy[result] {
	...
	az_language_service.local_auth_enabled == true
