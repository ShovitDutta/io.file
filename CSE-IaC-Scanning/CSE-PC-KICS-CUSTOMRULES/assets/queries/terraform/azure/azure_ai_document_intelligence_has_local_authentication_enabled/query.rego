...
# This policy checks if the azurerm_cognitive_account (Document Intelligence Service) resource has local_auth_enabled set to false.
...
CxPolicy[result] {
	...
	az_documentintelligence_service.local_auth_enabled == true
