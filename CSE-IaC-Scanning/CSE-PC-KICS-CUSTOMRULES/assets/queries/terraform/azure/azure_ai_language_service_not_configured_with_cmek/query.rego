...
CxPolicy[result] {
	...
	az_language_service_cmk =  az_language_service.customer_managed_key
	count(az_language_service_cmk) == 0
...
CxPolicy[result] {
	...
	az_language_service_cmk =  az_language_service.customer_managed_key[j]

    not is_valid_key(az_language_service_cmk.key_vault_key_id)
