...
# This policy checks if the azurerm_cognitive_account (ContentSafety Services) resource has local_auth_enabled set to false.
...
CxPolicy[result] {
	...
	az_contentsafety_service.local_auth_enabled == true
