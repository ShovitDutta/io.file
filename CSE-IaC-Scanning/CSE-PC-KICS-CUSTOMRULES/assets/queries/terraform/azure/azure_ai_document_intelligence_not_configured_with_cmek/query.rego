...
CxPolicy[result] {
	...
	az_documentintelligence_service_cmk =  az_documentintelligence_service.customer_managed_key
	count(az_documentintelligence_service_cmk) == 0
...
CxPolicy[result] {
	...
	az_documentintelligence_service_cmk =  az_documentintelligence_service.customer_managed_key[j]

    not is_valid_key(az_documentintelligence_service_cmk.key_vault_key_id)
