...
# This policy checks if the azurerm_cognitive_account (Computer Vision Servcices) resource has public_network_access_enabled set to false.
...
CxPolicy[result] {
	...
	az_computervision_service.public_network_access_enabled == true
