...
CxPolicy[result] {
	...
	az_translation_service_cmk =  az_translation_service.customer_managed_key
	count(az_translation_service_cmk) == 0
...
CxPolicy[result] {
	...
	az_translation_service_cmk =  az_translation_service.customer_managed_key[j]

    not is_valid_key(az_translation_service_cmk.key_vault_key_id)
