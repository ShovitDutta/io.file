...
CxPolicy[result] {
        ...
        actualregion := vertexaimetadatastore.region
        ...
        result := {
                ...
                "keyExpectedValue": sprintf("google_vertex_ai_metadata_store[%s].region should be defined in approved region", [name]),
                "keyActualValue": sprintf("google_vertex_ai_metadata_store[%s].region is not defined in approved region", [name]),
                "searchLine": common_lib.build_search_line(["resource", "google_vertex_ai_metadata_store", name, "region"], []),
